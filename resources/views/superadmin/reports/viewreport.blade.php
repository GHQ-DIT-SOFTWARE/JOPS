...
@section('main')
    ...
    <section class="pcoded-main-container">
        <div class="pcoded-content">
            ...
            <div class="card">
                ...
                <label class="mt-4" style="background-color: navy; color: white; padding: 4px 8px; border-radius: 4px; width:300px; font-size: 1.5em">
    GENERAL</label>
                <table class="table table-bordered table-sm">
                    <tr>
    ...
    SITREP - NAVY</label>
                ...
                </table>               <label class="mt-4" style="background-color: navy; color: white; padding: 4px 8px; border-radius: 4px; width:300px; font-size: 1.5em">
